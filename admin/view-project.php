...
$view=$_GET['V'];
$sel="SELECT * FROM project WHERE pro_id='$view'";
            ...
            <div class="col-md-8">
                <table class="table table-bordered table-striped table-hover custom_view_table">
                   <tr>
                    ...
                    <td>
            <?php if($V['pro_img']!=''){ ?>
              <img height="100px" class="img200" src="uploads/<?= $V['pro_img'] ?>"  alt="project"/> 
           <?php }else{ ?>
            <img height="100px" src="images/avatar.jpg" alt="project"/> 
           <?php } ?> 
                    </td>  
                  </tr>
                  <tr>
