<!-- Footer Start -->
    <div class="container-fluid bg-dark text-body footer mt-5 pt-5 wow fadeIn" data-wow-delay="0.1s">
        ...
        <div class="row g-5">
          <div class="col-lg-3 col-md-6">
            ...
            <div class="d-flex pt-2">
              <a class="btn btn-square btn-outline-secondary rounded-circle me-1" href="">
              ...
              <a class="btn btn-square btn-outline-secondary rounded-circle me-0" href="">
      ...
      <div class="container-fluid copyright">
        <div class="container">
          <div class="row">
            <div class="col-md-6 text-center text-md-start mb-3 mb-md-0"> &copy; <a href="#"></a> All Right Reserved. </div>
            </div>
        </div>
      </div>
    </div>
